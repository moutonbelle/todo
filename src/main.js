...
class ToDoController {
  ...
  addProject(projectName, projectID = null) {
    this.system.addProject(projectName, projectID);
  }

  removeProject(projectID) {
    this.system.removeProject(projectID);
  }
  ...
  removeTodo(projectID, todoID) {
    this.system.removeTodo(projectID, todoID);
  }

  updateTodo(projectID, todoID, updates) {
    this.system.updateTodo(projectID, todoID, updates);
  }

  moveTodo(oldProjectID, newProjectID, todoID) {
    this.system.moveTodo(oldProjectID, newProjectID, todoID);
  }
  ...
  draw() {
    this.renderer.draw(this.target, this.system, this.uiState);
  }
  ...
  clickHandler = (e) => {
    ...
    if (e.target.classList.contains("cancel-todo-edit")) {
      if (
        this.system
          .getProjectByID(e.target.dataset.projectID)
          .getTodoByID(e.target.dataset.todoID).title === null
      )
        this.removeTodo(e.target.dataset.projectID, e.target.dataset.todoID);
